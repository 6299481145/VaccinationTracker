            ...
            <div class="main-column">
                ...
                <div>
                    <select name="district" id="district">
                        <option value="">Select</option>
                        <option value="Muzaffarpur" <?php if ($child['district'] == 'Muzaffarpur') echo 'Selected'; ?>>Muzaffarpur</option>
                        <option value="Vaishali" <?php if ($child['district'] == 'Vaishali') echo 'Selected'; ?>>Vaishali</option>
                        <option value="Sitamarhi" <?php if ($child['district'] == 'Sitamarhi') echo 'Selected'; ?>>Sitamarhi</option>
                        <option value="Saran" <?php if ($child['district'] == 'Saran') echo 'Selected'; ?>>Saran</option>
                        <option value="Sivan" <?php if ($child['district'] == 'Sivan') echo 'Selected'; ?>>Sivan</option>
                        <option value="West champaran" <?php if ($child['district'] == 'West champaran') echo 'Selected'; ?>>West champaran</option>
                    </select>
                </div>
            </div>
            <div class="main-column">
                ...
                <div>
                    <?php fetch_existing_state($child['state']); ?>
                </div>
            </div>
        </div>
        <div class="main-row">
